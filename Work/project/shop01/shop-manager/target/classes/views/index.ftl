                ...
                <li class="user-footer">
                  <div class="pull-left">
                  	<a href="/index/Admin/Index/index" data-url="" class="btn btn-default btn-flat model-map">后台首页</a>
                   	...
                   	<a href="${ctx}/user/logout" class="btn btn-default btn-flat">安全退出</a>
                  </div>
                </li>
              </ul>
            </li>
	      ...
	      <li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<li onclick="makecss(this)" data-id="categoryList_Goods">
	            		<a href='${ctx}/goodsCategory/index' target='rightContent'><i class="fa fa-circle-o"></i>商品分类</a>
	            	</li><li onclick="makecss(this)" data-id="goodsList_Goods">
	            		<a href='${ctx}/goods/list/page' target='rightContent'><i class="fa fa-circle-o"></i>商品列表</a>
